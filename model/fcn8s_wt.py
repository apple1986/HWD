...
class down_wt(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.bn_relu_conv = nn.Sequential(nn.BatchNorm2d(in_ch*4),
...
class FCN8s_WT(nn.Module):


    def __init__(self, classes=9, channels=1):
        super(FCN8s_WT, self).__init__()
        # conv1
...
class FCN8s_WTAtOnce(FCN8s_WT):

#    pretrained_model = \
#        osp.expanduser('~/data/models/pytorch/fcn8s_wt-atonce_from_caffe.pth')
#
#    @classmethod
#    def download(cls):
...
if __name__ == '__main__':
    ...
    model = FCN8s_WT(classes=9, channels=1).to(device)
    model.eval()
