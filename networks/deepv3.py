...
from networks.nn.operators import conv_bn_relu, conv_sigmoid, _AtrousSpatialPyramidPoolingModule
...
def DeepR101V3PlusD_m1(num_classes, criterion):
    """
    ResNet-50 Based Network
    """
...
if __name__ == '__main__':
    ...
    model = DeepWV3Plus(num_classes=19).to(device)
    out = model(img)
    print(out.shape)
    # print(model)